...
export declare type Conv1DLayerSerialization = BaseLayerSerialization<'Conv1D', ConvLayerConfig>;
export declare type Conv2DLayerSerialization = BaseLayerSerialization<'Conv2D', ConvLayerConfig>;
export declare type Conv2DTransposeLayerSerialization = BaseLayerSerialization<'Conv2DTranspose', ConvLayerConfig>;
...
export declare type SeparableConv2DLayerSerialization = BaseLayerSerialization<'SeparableConv2D', ConvLayerConfig>;
...
export declare type Cropping2DLayerSerialization = BaseLayerSerialization<'Cropping2D', Cropping2DLayerConfig>;
export interface UpSampling2DLayerConfig extends LayerConfig {
    size?: number[];
    dataFormat?: DataFormatSerialization;
}
export declare type UpSampling2DLayerSerialization = BaseLayerSerialization<'UpSampling2D', UpSampling2DLayerConfig>;
export declare type ConvolutionalSerialization = Conv1DLayerSerialization | Conv2DLayerSerialization | Conv2DTransposeLayerSerialization | SeparableConv2DLayerSerialization | Cropping2DLayerSerialization | UpSampling2DLayerSerialization;
