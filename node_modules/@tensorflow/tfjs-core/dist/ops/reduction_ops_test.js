...
jasmine_util_1.describeWithFlags('Reduction: min', test_util_1.ALL_ENVS, function () {
    it('Tensor1D', function () {
        ...
        test_util_1.expectArraysClose(tf.min(a), -7);
    });
    it('ignores NaNs', function () {
        var a = tf.tensor1d([3, NaN, 2]);
        test_util_1.expectArraysEqual(tf.min(a), 2);
    });
    it('2D', function () {
    ...
    it('2D axis=[0,1]', function () {
        var a = tf.tensor2d([3, -1, 0, 100, -7, 2], [2, 3]);
        test_util_1.expectArraysClose(tf.min(a, [0, 1]), -7);
    });
    ...
    it('2D, axis=0, keepDims', function () {
        var a = tf.tensor2d([3, -1, 0, 100, -7, 2], [2, 3]);
        var r = tf.min(a, 0, true /* keepDims */);
    ...
    it('accepts a tensor-like object', function () {
        test_util_1.expectArraysClose(tf.min([3, -1, 0, 100, -7, 2]), -7);
    });
...
jasmine_util_1.describeWithFlags('Reduction: max', test_util_1.ALL_ENVS, function () {
    it('with one element dominating', function () {
        var a = tf.tensor1d([3, -1, 0, 100, -7, 2]);
        var r = tf.max(a);
        test_util_1.expectArraysClose(r, 100);
    });
    it('with all elements being the same', function () {
        var a = tf.tensor1d([3, 3, 3]);
        var r = tf.max(a);
        test_util_1.expectArraysClose(r, 3);
    });
    it('ignores NaNs', function () {
        test_util_1.expectArraysClose(tf.max(tf.tensor1d([3, NaN, 2])), 3);
    });
    it('2D', function () {
        var a = tf.tensor2d([3, -1, 0, 100, -7, 2], [2, 3]);
        test_util_1.expectArraysClose(tf.max(a), 100);
    });
    it('2D axis=[0,1]', function () {
        var a = tf.tensor2d([3, -1, 0, 100, -7, 2], [2, 3]);
        test_util_1.expectArraysClose(tf.max(a, [0, 1]), 100);
    });
    it('2D, axis=0', function () {
        var a = tf.tensor2d([3, -1, 0, 100, -7, 2], [2, 3]);
        var r = tf.max(a, [0]);
    ...
    it('2D, axis=0, keepDims', function () {
        var a = tf.tensor2d([3, -1, 0, 100, -7, 2], [2, 3]);
        var r = tf.max(a, [0], true /* keepDims */);
        expect(r.shape).toEqual([1, 3]);
        test_util_1.expectArraysClose(r, [100, -1, 2]);
    });
    it('2D, axis=1 provided as a number', function () {
...
jasmine_util_1.describeWithFlags('Reduction: argmax', test_util_1.ALL_ENVS, function () {
    it('Tensor1D', function () {
        ...
        test_util_1.expectArraysEqual(result, 2);
    });
    it('one value', function () {
        var a = tf.tensor1d([10]);
        var result = tf.argMax(a);
        expect(result.dtype).toBe('int32');
        test_util_1.expectArraysEqual(result, 0);
    });
    it('N > than parallelization threshold', function () {
        ...
        var result = tf.argMax(a);
        expect(result.dtype).toBe('int32');
        test_util_1.expectArraysEqual(result, n - 1);
    });
    it('3D, N > than parallelization threshold', function () {
        var n = reduce_util.PARALLELIZE_THRESHOLD * 2;
        var values = new Float32Array(n);
        for (var i = 0; i < n; i++) {
            values[i] = i;
        }
        var a = tf.tensor3d(values, [1, 1, n]);
        var result = tf.argMax(a, -1);
        expect(result.dtype).toBe('int32');
        test_util_1.expectArraysEqual(result, n - 1);
    });
    it('max index corresponds to start of a non-initial window', function () {
        ...
        var result = tf.argMax(a);
        expect(result.dtype).toBe('int32');
        test_util_1.expectArraysEqual(result, index);
    });
    it('5D, max index corresponds to start of a non-initial window', function () {
        var n = reduce_util.PARALLELIZE_THRESHOLD * 2;
        var windowSize = reduce_util.computeOptimalWindowSize(n);
        var values = new Float32Array(n);
        var index = windowSize * 2;
        values[index] = 1;
        var a = tf.tensor5d(values, [1, 1, 1, 1, n]);
        var result = tf.argMax(a, -1);
        expect(result.dtype).toBe('int32');
        test_util_1.expectArraysEqual(result, index);
    });
    it('ignores NaNs', function () {
        ...
        test_util_1.expectArraysEqual(res, 2);
    });
    it('2D, no axis specified', function () {
        var a = tf.tensor2d([3, -1, 0, 100, -7, 2], [2, 3]);
        test_util_1.expectArraysEqual(tf.argMax(a), [1, 0, 1]);
    });
    it('4D, no axis specified', function () {
        var a = tf.tensor4d([3, -1, 0, 100, -7, 2], [2, 1, 1, 3]);
        test_util_1.expectArraysEqual(tf.argMax(a), [1, 0, 1]);
    });
    it('2D, axis=0', function () {
        var a = tf.tensor2d([3, -1, 0, 100, -7, 2], [2, 3]);
    ...
    it('6D, axis=0', function () {
        var a = tf.tensor6d([3, -1, 0, 100, -7, 2], [2, 1, 1, 1, 1, 3]);
        var r = tf.argMax(a, 0);
    ...
    it('accepts tensor with bool values', function () {
        ...
        expect(result.dtype).toBe('int32');
        test_util_1.expectArraysEqual(result, 1);
    });
...
jasmine_util_1.describeWithFlags('Reduction: webgl packed input', test_util_1.WEBGL_ENVS, function () {
    it('argmax 3D, odd number of rows, axis = -1', function () {
        ...
        var a = tf.tensor3d([3, 2, 5, 100, -7, 2], [2, 1, 3]).add(1);
        var r = tf.argMax(a, -1);
    ...
    it('argmin 4D, odd number of rows, axis = -1', function () {
        var webglLazilyUnpackFlagSaved = tf.ENV.get('WEBGL_LAZILY_UNPACK');
        tf.ENV.set('WEBGL_LAZILY_UNPACK', true);
        var webglPackBinaryOperationsFlagSaved = tf.ENV.get('WEBGL_PACK_BINARY_OPERATIONS');
        tf.ENV.set('WEBGL_PACK_BINARY_OPERATIONS', true);
        var a = tf.tensor4d([3, 2, 5, 100, -7, 2, 8, 7, -5, 101, 7, -2, 100, -7, 2, 8, 7, -5], [1, 2, 3, 3])
            .add(1);
        var r = tf.argMin(a, -1);
        tf.ENV.set('WEBGL_LAZILY_UNPACK', webglLazilyUnpackFlagSaved);
        tf.ENV.set('WEBGL_PACK_BINARY_OPERATIONS', webglPackBinaryOperationsFlagSaved);
        expect(r.dtype).toBe('int32');
        test_util_1.expectArraysEqual(r, [1, 1, 2, 2, 1, 2]);
    });
    it('should not leak memory when called after unpacked op', function () {
        var webglPackBinaryOperationsFlagSaved = tf.ENV.get('WEBGL_PACK_BINARY_OPERATIONS');
        tf.ENV.set('WEBGL_PACK_BINARY_OPERATIONS', false);
        var a = tf.tensor5d([3, 2, 5, 100, -7, 2, 8, 7, -5, 101, 7, -2, 100, -7, 2, 8, 7, -5], [1, 2, 3, 1, 3])
            .add(1);
...
jasmine_util_1.describeWithFlags('Reduction: argmin', test_util_1.ALL_ENVS, function () {
    ...
    it('4D, N > than parallelization threshold', function () {
        var n = reduce_util.PARALLELIZE_THRESHOLD * 2;
        var values = new Float32Array(n);
        for (var i = 0; i < n; i++) {
            values[i] = n - i;
        }
        var a = tf.tensor4d(values, [1, 1, 1, n]);
        var result = tf.argMin(a, -1);
        expect(result.dtype).toBe('int32');
        test_util_1.expectArraysEqual(result, n - 1);
    });
    ...
    it('ignores NaNs', function () {
        ...
        var res = tf.argMin(a);
        test_util_1.expectArraysEqual(res, 3);
    });
    it('3D, ignores NaNs', function () {
        var a = tf.tensor3d([5, 0, NaN, -1, 3], [1, 1, 5]);
        var res = tf.argMin(a, -1);
        test_util_1.expectArraysEqual(res, 3);
    });
    it('2D, no axis specified', function () {
        var a = tf.tensor2d([3, -1, 0, 100, -7, 2], [2, 3]);
...
jasmine_util_1.describeWithFlags('Reduction: logSumExp', test_util_1.ALL_ENVS, function () {
    ...
    it('basic', function () {
        ...
        var result = tf.logSumExp(a);
        test_util_1.expectArraysClose(result, Math.log(Math.exp(1) + Math.exp(2) + Math.exp(-3)));
    });
    it('propagates NaNs', function () {
        var a = tf.tensor1d([1, 2, NaN]);
        var result = tf.logSumExp(a);
        test_util_1.expectArraysEqual(result, NaN);
    });
    ...
    it('axes=0 in 2D array, keepDims', function () {
        var a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
        var r = tf.logSumExp(a, [0], true /* keepDims */);
...
jasmine_util_1.describeWithFlags('Reduction: sum', test_util_1.ALL_ENVS, function () {
    ...
    it('sums across axis=0 in 2D array, keepDims', function () {
        var a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
        var res = tf.sum(a, [0], true /* keepDims */);
...
jasmine_util_1.describeWithFlags('Reduction: prod', test_util_1.ALL_ENVS, function () {
    ...
    it('propagates NaNs', function () {
        var a = tf.tensor2d([1, 2, 3, NaN, 0, 1], [3, 2]);
        test_util_1.expectArraysEqual(tf.prod(a), NaN);
    });
    it('prod over dtype int32', function () {
        var a = tf.tensor1d([1, 5, 7, 3], 'int32');
        var prod = tf.prod(a);
        test_util_1.expectArraysEqual(prod, 105);
    });
    it('prod over dtype bool', function () {
        var a = tf.tensor1d([true, false, false, true, true], 'bool');
        var prod = tf.prod(a);
        test_util_1.expectArraysEqual(prod, 0);
    });
    it('prods all values in 2D array with keep dim', function () {
        var a = tf.tensor2d([1, 2, 3, 1, 0, 1], [3, 2]);
        var res = tf.prod(a, null, true /* keepDims */);
        expect(res.shape).toEqual([1, 1]);
    ...
    it('prods across axis=0 in 2D array, keepDims', function () {
        var a = tf.tensor2d([1, 2, 3, 1, 0, 1], [3, 2]);
        var res = tf.prod(a, [0], true /* keepDims */);
        expect(res.shape).toEqual([1, 2]);
        test_util_1.expectArraysClose(res, [0, 2]);
    });
    ...
    it('accepts a tensor-like object', function () {
        ...
        test_util_1.expectArraysClose(result, 6);
    });
    it('throws error for string tensor', function () {
...
jasmine_util_1.describeWithFlags('Reduction: mean', test_util_1.ALL_ENVS, function () {
    it('basic', function () {
        ...
        test_util_1.expectArraysClose(r, 7 / 6);
    });
    it('propagates NaNs', function () {
        var a = tf.tensor2d([1, 2, 3, NaN, 0, 1], [3, 2]);
        var r = tf.mean(a);
        expect(r.dtype).toBe('float32');
        test_util_1.expectArraysEqual(r, NaN);
    });
    it('mean(int32) => float32', function () {
        var a = tf.tensor1d([1, 5, 7, 3], 'int32');
        var r = tf.mean(a);
        expect(r.dtype).toBe('float32');
        test_util_1.expectArraysClose(r, 4);
    });
    it('mean(bool) => float32', function () {
        var a = tf.tensor1d([true, false, false, true, true], 'bool');
        var r = tf.mean(a);
        expect(r.dtype).toBe('float32');
        test_util_1.expectArraysClose(r, 3 / 5);
    });
    it('2D array with keep dim', function () {
        var a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
        var res = tf.mean(a, null, true /* keepDims */);
        expect(res.shape).toEqual([1, 1]);
    ...
    it('axis=0 in 2D array, keepDims', function () {
        var a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
        var res = tf.mean(a, [0], true /* keepDims */);
        expect(res.shape).toEqual([1, 2]);
        expect(res.dtype).toBe('float32');
        test_util_1.expectArraysClose(res, [4 / 3, 1]);
    });
...
jasmine_util_1.describeWithFlags('Reduction: moments', test_util_1.ALL_ENVS, function () {
    ...
    it('propagates NaNs', function () {
        ...
        expect(mean.dtype).toBe('float32');
        expect(variance.dtype).toBe('float32');
        test_util_1.expectArraysEqual(mean, NaN);
        test_util_1.expectArraysEqual(variance, NaN);
    });
    it('moments(int32) => float32', function () {
        ...
        expect(mean.dtype).toBe('float32');
        expect(variance.dtype).toBe('float32');
        test_util_1.expectArraysClose(mean, 4);
        test_util_1.expectArraysClose(variance, 5);
    });
    it('moments(bool) => float32', function () {
        ...
        expect(mean.dtype).toBe('float32');
        expect(variance.dtype).toBe('float32');
        test_util_1.expectArraysClose(mean, 3 / 5);
        test_util_1.expectArraysClose(variance, 0.23999998);
    });
    it('2D array with keep dim', function () {
        var a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
        var _a = tf.moments(a, null, true /* keepDims */), mean = _a.mean, variance = _a.variance;
...
jasmine_util_1.describeWithFlags('Reduction: norm', test_util_1.ALL_ENVS, function () {
    it('scalar norm', function () {
        ...
        test_util_1.expectArraysClose(norm, 22);
    });
    ...
    it('vector -inf norm', function () {
        ...
        var norm = tf.norm(a, -Infinity);
        expect(norm.dtype).toBe('float32');
        test_util_1.expectArraysClose(norm, 1);
    });
    it('vector 1 norm', function () {
        var a = tf.tensor1d([1, -2, 3, -4]);
        var norm = tf.norm(a, 1);
        expect(norm.dtype).toBe('float32');
        test_util_1.expectArraysClose(norm, 10);
    });
    it('vector euclidean norm', function () {
        var a = tf.tensor1d([1, -2, 3, -4]);
        var norm = tf.norm(a, 'euclidean');
        expect(norm.dtype).toBe('float32');
        test_util_1.expectArraysClose(norm, 5.4772);
    });
    ...
    it('matrix 1 norm', function () {
        ...
        expect(norm.dtype).toBe('float32');
        test_util_1.expectArraysClose(norm, 5);
    });
    it('matrix euclidean norm', function () {
        var a = tf.tensor2d([1, 2, -3, 1, 1, 1], [3, 2]);
        var norm = tf.norm(a, 'euclidean', [0, 1]);
        expect(norm.dtype).toBe('float32');
        test_util_1.expectArraysClose(norm, 4.123);
    });
    ...
    it('propagates NaNs for norm', function () {
        ...
        var norm = tf.norm(a);
        expect(norm.dtype).toBe('float32');
        test_util_1.expectArraysEqual(norm, NaN);
    });
    ...
    it('2D array norm with keep dim', function () {
        var a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
        var norm = tf.norm(a, Infinity, null, true /* keepDims */);
...
jasmine_util_1.describeWithFlags('Reduction: all', test_util_1.ALL_ENVS, function () {
    it('Tensor1D', function () {
        ...
        test_util_1.expectArraysClose(tf.all(a), 0);
        a = tf.tensor1d([1, 0, 1], 'bool');
        test_util_1.expectArraysClose(tf.all(a), 0);
        a = tf.tensor1d([1, 1, 1], 'bool');
        test_util_1.expectArraysClose(tf.all(a), 1);
    });
    it('ignores NaNs', function () {
        var a = tf.tensor1d([1, NaN, 1], 'bool');
        test_util_1.expectArraysEqual(tf.all(a), 1);
    });
    it('2D', function () {
    ...
    it('2D axis=[0,1]', function () {
        ...
        test_util_1.expectArraysClose(tf.all(a, [0, 1]), 0);
    });
    it('2D, axis=0', function () {
        var a = tf.tensor2d([1, 1, 0, 0], [2, 2], 'bool');
        var r = tf.all(a, 0);
...
jasmine_util_1.describeWithFlags('Reduction: any', test_util_1.ALL_ENVS, function () {
    it('Tensor1D', function () {
        var a = tf.tensor1d([0, 0, 0], 'bool');
        test_util_1.expectArraysClose(tf.any(a), 0);
        a = tf.tensor1d([1, 0, 1], 'bool');
        test_util_1.expectArraysClose(tf.any(a), 1);
        a = tf.tensor1d([1, 1, 1], 'bool');
        test_util_1.expectArraysClose(tf.any(a), 1);
    });
    it('ignores NaNs', function () {
        var a = tf.tensor1d([1, NaN, 0], 'bool');
        test_util_1.expectArraysEqual(tf.any(a), 1);
    });
    it('2D', function () {
        var a = tf.tensor2d([1, 1, 0, 0], [2, 2], 'bool');
        test_util_1.expectArraysClose(tf.any(a), 1);
    ...
    it('2D axis=[0,1]', function () {
        var a = tf.tensor2d([1, 1, 0, 0, 1, 0], [2, 3], 'bool');
        test_util_1.expectArraysClose(tf.any(a, [0, 1]), 1);
    });
    it('2D, axis=0', function () {
        var a = tf.tensor2d([1, 1, 0, 0], [2, 2], 'bool');
        var r = tf.any(a, 0);
