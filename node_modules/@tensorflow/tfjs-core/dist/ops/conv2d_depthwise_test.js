...
jasmine_util_1.describeWithFlags('depthwiseConv2d packed', test_util_1.PACKED_ENVS, function () {
...
jasmine_util_1.describeWithFlags('depthwiseConv2D', test_util_1.ALL_ENVS, function () {
    ...
    it('input=1x5x5x1,f=3,s=1,d=1,p=valid,chMul=1', function () {
        var fSize = 3;
        var pad = 'valid';
        var stride = 1;
        var chMul = 1;
    ...
    it('input=1x5x5x1,f=3,s=1,d=2,p=valid,chMul=1', function () {
        var fSize = 3;
        var pad = 'valid';
        var stride = 1;
        var dilation = 2;
    ...
    it('input=1x5x5x1,f=3,s=1,d=1,p=same,chMul=1', function () {
        var fSize = 3;
        var pad = 'same';
        var stride = 1;
        var chMul = 1;
    ...
    it('input=1x5x5x1,f=3,s=1,d=2,p=same,chMul=1', function () {
        var fSize = 3;
        var pad = 'valid';
        var stride = 1;
        var chMul = 1;
    ...
    it('TensorLike', function () {
        ...
        var w = [[[[0.303873]], [[0.229223]]], [[[0.144333]], [[0.803373]]]];
        var result = tf.depthwiseConv2d(x, w, stride, pad);
        var expected = [1.07022, 1.03167, 0.67041, 0.778863];
        test_util_1.expectArraysClose(result, expected);
    });
    it('TensorLike Chained', function () {
        ...
        var w = [[[[0.303873]], [[0.229223]]], [[[0.144333]], [[0.803373]]]];
        var result = x.depthwiseConv2D(w, stride, pad);
        expect(result.shape).toEqual([1, 2, 2, 1]);
        var expected = [1.07022, 1.03167, 0.67041, 0.778863];
        test_util_1.expectArraysClose(result, expected);
    });
...
jasmine_util_1.describeWithFlags('depthwiseConv2d gradients', test_util_1.ALL_ENVS, function () {
    ...
    it('wrt input and filter, 1x3x3x1 and 2x2x1x1', function () {
        ...
        var _a = tf.grads(function (x, f) {
            return tf.depthwiseConv2d(x, f, stride, pad);
        })([x, f]), dx = _a[0], df = _a[1];
        test_util_1.expectArraysClose(dx, tf.tensor4d([[
