...
jasmine_util_1.describeWithFlags('conv1d', test_util_1.ALL_ENVS, function () {
    ...
    it('conv1d input=4x1,d2=1,f=2x1x1,s=1,d=1,p=valid', function () {
        ...
        test_util_1.expectArraysClose(result, [4, 7, 10]);
    });
    ...
    it('TensorLike Chained', function () {
        ...
        var x = tf.tensor3d([1, 2, 3, 4], inputShape);
        var w = [[[3]]];
        var result = x.conv1d(w, stride, pad, dataFormat, dilation);
        expect(result.shape).toEqual([2, 2, 1]);
        test_util_1.expectArraysClose(result, [3, 6, 9, 12]);
    });
    ...
    it('conv1d gradients, input=2x2x1,d2=1,f=1,s=1,d=1,p=same', function () {
        ...
        test_util_1.expectArraysClose(dw, [10]);
    });
    it('conv1d gradients input=14x1,d2=1,f=3x1x1,s=1,p=valid', function () {
        ...
        expect(dw.shape).toEqual(w.shape);
        test_util_1.expectArraysClose(dw, [102, 120, 138]);
    });
});
