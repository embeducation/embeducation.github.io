...
export declare class GPGPUContext {
    ...
    uploadMatrixToPackedTexture(texture: WebGLTexture, batch: number, rows: number, columns: number, physicalRows: number, physicalCols: number, matrix: Float32Array): void;
