...
var argminmax_packed_gpu_1 = require("./webgl/argminmax_packed_gpu");
...
var binaryop_packed_gpu = require("./webgl/binaryop_packed_gpu");
...
var concat_packed_gpu_1 = require("./webgl/concat_packed_gpu");
...
var fill_gpu_1 = require("./webgl/fill_gpu");
...
var resize_bilinear_packed_gpu_1 = require("./webgl/resize_bilinear_packed_gpu");
...
var slice_packed_gpu_1 = require("./webgl/slice_packed_gpu");
...
var transpose_packed_gpu_1 = require("./webgl/transpose_packed_gpu");
...
var MathBackendWebGL = /** @class */ (function () {
    ...
    MathBackendWebGL.prototype.read = function (dataId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, subscribers_1, texData, texture, values, texShape, isPacked, shape, slice, dtype, program, res, data, width, height, bufferOrTexture, vals, size, batch, rows, cols, dTypeVals, subscribers;
    ...
    MathBackendWebGL.prototype.disposeData = function (dataId) {
        ...
        if (this.texData.has(dataId)) {
            var _a = this.texData.get(dataId), texture = _a.texture, dtype = _a.dtype, texShape = _a.texShape, usage = _a.usage, complexTensors = _a.complexTensors, isPacked = _a.isPacked, slice = _a.slice;
            if (texture != null) {
    ...
    MathBackendWebGL.prototype.concat = function (tensors, axis) {
        ...
        if (environment_1.ENV.get('WEBGL_PACK_ARRAY_OPERATIONS') && tensors[0].rank > 1) {
    ...
    MathBackendWebGL.prototype.argMinMaxReduce = function (x, axis, reduceType) {
        ...
        if (!environment_1.ENV.get('WEBGL_PACK_REDUCE') || x.rank <= 2) {
            var _a = axis_util.computeOutAndReduceShapes(x.shape, axes), outShape = _a[0], reduceShape = _a[1];
            var inSize = util.sizeFromShape(reduceShape);
            var a2D = x.as2D(-1, inSize);
    ...
    MathBackendWebGL.prototype.packedBinaryOp = function (a, b, op, dtype) {
        var program = new binaryop_packed_gpu_1.BinaryOpPackedProgram(op, a.shape, b.shape);
        var output = this.makePackedTensor(program.outputShape, dtype);
        return this.compileAndRun(program, [a, b], output);
    };
    /**
    ...
    MathBackendWebGL.prototype.pow = function (a, b) {
        var usePackedOp = environment_1.ENV.get('WEBGL_PACK_BINARY_OPERATIONS');
    ...
    MathBackendWebGL.prototype.exp = function (x) {
        var program;
        if (environment_1.ENV.get('WEBGL_PACK')) {
    ...
    MathBackendWebGL.prototype.conv2dByMatMul = function (x, filter, convInfo) {
        ...
        if (!environment_1.ENV.get('WEBGL_LAZILY_UNPACK') ||
            !environment_1.ENV.get('WEBGL_PACK_BINARY_OPERATIONS') || xShape[2] % 2 === 0 ||
            !xTexData.isPacked) {
    ...
    MathBackendWebGL.prototype.depthwiseConv2D = function (x, filter, convInfo) {
        var program;
        if (environment_1.ENV.get('WEBGL_PACK_DEPTHWISECONV') && convInfo.strideWidth <= 2 &&
    ...
    MathBackendWebGL.prototype.resizeBilinear = function (x, newHeight, newWidth, alignCorners) {
        var program = environment_1.ENV.get('WEBGL_PACK_IMAGE_OPERATIONS') ?
    ...
    MathBackendWebGL.prototype.compileAndRun = function (program, inputs, output, customSetup, pageToCpu) {
        ...
        var numBytesBeforePaging = environment_1.ENV.get('WEBGL_NUM_MB_BEFORE_PAGING') * 1024;
        if (pageToCpu && this.numBytesInGPU > numBytesBeforePaging) {
            ...
            while (numBytesToPage > 0 && this.lruDataGPU.length > 0) {
                ...
                var _a = this.texData.get(dataId), texShape = _a.texShape, dtype = _a.dtype;
    ...
    MathBackendWebGL.prototype.floatPrecision = function () {
        ...
        return globals_1.tidy(function () {
            ...
            var debugFlag = environment_1.ENV.get('DEBUG');
    ...
    MathBackendWebGL.prototype.uploadToGPU = function (dataId) {
        ...
        if (texture != null) {
            ...
            if (environment_1.ENV.get('WEBGL_NUM_MB_BEFORE_PAGING') < Number.POSITIVE_INFINITY) {
        ...
        var newTexture = this.acquireTexture(dataId, texShape, usage, dtype, isPacked);
    ...
    MathBackendWebGL.prototype.releaseTexture = function (dataId, texture, texShape, texType, dtype, isPacked) {
        if (environment_1.ENV.get('WEBGL_NUM_MB_BEFORE_PAGING') < Number.POSITIVE_INFINITY) {
    ...
    MathBackendWebGL.prototype.acquireTexture = function (dataId, texShape, texType, dtype, isPacked) {
        if (environment_1.ENV.get('WEBGL_NUM_MB_BEFORE_PAGING') < Number.POSITIVE_INFINITY) {
            this.lruDataGPU.push(dataId);
        }
        this.numBytesInGPU += this.computeBytes(texShape, dtype);
...
if (environment_1.ENV.get('IS_BROWSER')) {
    environment_1.ENV.registerBackend('webgl', function () { return new MathBackendWebGL(); }, 2 /* priority */);
}
