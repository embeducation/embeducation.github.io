...
jasmine_util_1.describeWithFlags('localResponseNormalization with Tensor3D', test_util_1.ALL_ENVS, function () {
    ...
    it('computes simple normalization across channels', function () {
        var xT = tf.tensor3d([1, 20, 300, 4], [1, 1, 4]);
        var radius = 1;
        var bias = 1;
        var alpha = 1;
        var beta = 0.5;
        var result = xT.localResponseNormalization(radius, bias, alpha, beta);
        var f = function () {
            var vals = [];
    ...
    it('computes complex normalization across channels', function () {
        var xT = tf.tensor3d([1, 20, 300, 4, 5, 15, 24, 200, 1, 20, 300, 4, 5, 15, 24, 200], [2, 2, 4]);
        var radius = 1;
        var bias = 1;
        var alpha = 1;
        var beta = 0.5;
...
jasmine_util_1.describeWithFlags('localResponseNormalization with Tensor4D', test_util_1.ALL_ENVS, function () {
    ...
    it('computes simple normalization across channels', function () {
        var xT = tf.tensor4d([1, 20, 300, 4, 1, 20, 300, 4], [2, 1, 1, 4]);
        var radius = 1;
        var bias = 1;
        var alpha = 1;
        var beta = 0.5;
