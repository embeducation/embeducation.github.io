...
function onesLike_(x) {
    ...
    return environment_1.ENV.engine.runKernel(function (backend) { return backend.onesLike($x); }, { $x: $x }, null);
}
/**
...
function zerosLike_(x) {
    ...
    return environment_1.ENV.engine.runKernel(function (backend) { return backend.zerosLike($x); }, { $x: $x }, null);
}
/**
