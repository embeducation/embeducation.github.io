...
jasmine_util_1.describeWithFlags('div', test_util_1.ALL_ENVS, function () {
    ...
    it('TensorLike', function () {
        var a = [0, 1, -2, -4, 4, -4];
        var b = [0.15, 0.2, 0.25, 0.5, 0.7, 1.2];
    ...
    it('upcasts when dtypes dont match', function () {
        var res = tf.div(tf.scalar(6, 'int32'), tf.scalar(3, 'float32'));
        expect(res.dtype).toBe('float32');
        test_util_1.expectArraysClose(res, [2]);
...
jasmine_util_1.describeWithFlags('mul', test_util_1.ALL_ENVS, function () {
    ...
    it('broadcast 5D + 2D', function () {
        var a = tf.range(1, 33).reshape([2, 2, 2, 2, 2]);
        var b = tf.tensor([2, 3], [2, 1]);
        var result = tf.mul(a, b);
    ...
    it('gradient: Scalar', function () {
        ...
        expect(da.shape).toEqual(a.shape);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, b.mul(dy));
        expect(db.shape).toEqual(b.shape);
        expect(db.dtype).toEqual('float32');
        test_util_1.expectArraysClose(db, a.mul(dy));
    });
    it('gradient: Tensor1D', function () {
        var a = tf.tensor1d([1, 2, 3]);
        var b = tf.tensor1d([3, 4, 5]);
    ...
    it('upcasts when dtypes dont match', function () {
        var res = tf.mul(tf.scalar(2, 'int32'), tf.scalar(3, 'float32'));
        expect(res.dtype).toBe('float32');
        test_util_1.expectArraysClose(res, [6]);
...
jasmine_util_1.describeWithFlags('pow', test_util_1.ALL_ENVS, function () {
    ...
    it('gradient wrt exponent with negative base', function () {
        var a = tf.tensor1d([-1, -.5, -2.7]);
        var b = tf.tensor1d([3, 2, -1], 'int32');
        var dy = tf.tensor1d([1, 1, 1]);
        var grads = tf.grads(function (a, b) { return tf.pow(a, b); });
        var _a = grads([a, b], dy), db = _a[1];
        expect(db.shape).toEqual(b.shape);
        expect(db.dtype).toEqual('float32');
        test_util_1.expectArraysClose(db, [0, 0, 0]);
    });
    it('gradient: scalar / Tensor1D', function () {
        var a = tf.scalar(2);
        var b = tf.tensor1d([3, 4, 5]);
...
jasmine_util_1.describeWithFlags('add', test_util_1.ALL_ENVS, function () {
    ...
    it('upcasts when dtypes dont match', function () {
        var res = tf.add(tf.scalar(1, 'int32'), tf.scalar(1, 'float32'));
        expect(res.dtype).toBe('float32');
        test_util_1.expectArraysClose(res, [2]);
        ...
        test_util_1.expectArraysClose(res, [5, 7]);
...
jasmine_util_1.describeWithFlags('sub', test_util_1.ALL_ENVS, function () {
    ...
    it('upcasts when dtypes dont match', function () {
        var res = tf.sub(tf.scalar(1, 'int32'), tf.scalar(1, 'float32'));
        expect(res.dtype).toBe('float32');
        test_util_1.expectArraysClose(res, [0]);
        ...
        expect(res.dtype).toBe('complex64');
        test_util_1.expectArraysClose(res, [3, 7]);
