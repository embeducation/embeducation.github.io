...
jasmine_util_1.describeWithFlags('reverse2d', test_util_1.ALL_ENVS, function () {
    ...
    it('reverse a 2D array at axis [1]', function () {
        ...
        var result = tf.reverse2d(a, axis);
        expect(result.shape).toEqual(a.shape);
        test_util_1.expectArraysClose(result, [3, 2, 1, 6, 5, 4]);
    });
    ...
    it('grad', function () {
        ...
        test_util_1.expectArraysClose(da, [60, 50, 40, 30, 20, 10]);
    });
    it('grad with reverse(axis=0)', function () {
        ...
        expect(da.shape).toEqual([2, 3]);
        test_util_1.expectArraysClose(da, [40, 50, 60, 10, 20, 30]);
    });
