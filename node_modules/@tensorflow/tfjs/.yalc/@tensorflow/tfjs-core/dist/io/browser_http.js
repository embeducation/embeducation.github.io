...
var BrowserHTTPRequest = /** @class */ (function () {
    function BrowserHTTPRequest(path, loadOptions) {
        ...
        this.fetchFunc = function (path, requestInits) {
            ...
            return loadOptions.fetchFunc(path, requestInits).catch(function (error) {
                throw new Error("Request for " + path + " failed due to error: " + error);
            });
        };
        util_1.assert(path != null && path.length > 0, function () {
            return 'URL path for browserHTTPRequest must not be null, undefined or ' +
                'empty.';
        });
        if (Array.isArray(path)) {
            util_1.assert(path.length === 2, function () { return 'URL paths for browserHTTPRequest must have a length of 2, ' +
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getFetchFunc()(this.path, init)];
                    case 1:
                        response = _a.sent();
                        if (response.ok) {
                            return [2 /*return*/, {
    ...
    BrowserHTTPRequest.prototype.load = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modelConfigRequest, modelConfig, e_1, message, modelTopology, weightsManifest, weightSpecs, weightData, weightsManifest_1, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFetchFunc()(this.path, this.requestInit)];
                    case 1:
                    ...
                    case 4:
                        e_1 = _a.sent();
                        message = "Failed to parse model JSON for request to " + this.path + ".";
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.loadWeights(weightsManifest_1)];
                    case 6:
                        results = _a.sent();
    ...
    BrowserHTTPRequest.prototype.loadWeights = function (weightsManifest) {
        return __awaiter(this, void 0, void 0, function () {
            var weightPath, _a, prefix, suffix, pathPrefix, weightSpecs, _i, weightsManifest_2, entry, fetchURLs, buffers;
...
exports.httpRequestRouter = function (url, onProgress) {
    if (typeof fetch === 'undefined') {
        ...
        if (isHTTP) {
            return browserHTTPRequest(url, { onProgress: onProgress });
        }
    }
    return null;
};
