            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        handler = tf.io.browserHTTPRequest('./model.json', { requestInit: { headers: { 'header_key_1': 'header_value_1' } } });
                        return [4 /*yield*/, handler.load()];
                    case 1:
                        modelArtifacts = _a.sent();
                        expect(modelArtifacts.modelTopology).toEqual(modelTopology1);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchInputs = [];
                    fetchInits = [];
                    handler = tf.io.browserHTTPRequest('./model.json', { requestInit: { credentials: 'include' }, fetchFunc: customFetch });
                    return [4 /*yield*/, handler.load()];
                case 1:
                    modelArtifacts = _a.sent();
                    expect(modelArtifacts.modelTopology).toEqual(modelTopology1);
