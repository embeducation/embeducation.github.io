...
var GPGPUContext = /** @class */ (function () {
    function GPGPUContext(gl) {
        ...
        this.itemsToPoll = [];
        var glVersion = environment_1.ENV.get('WEBGL_VERSION');
        if (gl != null) {
            this.gl = gl;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.getQueryTime(query, environment_1.ENV.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION'))];
                }
            });
        });
    };
