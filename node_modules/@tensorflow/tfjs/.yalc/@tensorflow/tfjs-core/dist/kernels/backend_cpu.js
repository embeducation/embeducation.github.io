...
var MathBackendCPU = /** @class */ (function () {
    ...
    MathBackendCPU.prototype.maxPoolBackprop = function (dy, x, y, convInfo) {
        ...
        var maxPosBuf = maxPositions.bufferSync();
        var dyBuf = dy.bufferSync();
        for (var b = 0; b < convInfo.batchSize; ++b) {
            for (var d = 0; d < convInfo.inChannels; ++d) {
    ...
    MathBackendCPU.prototype.oneHot = function (indices, depth, onValue, offValue) {
        ...
        res.fill(offValue);
        var indicesVal = indices.dataSync();
    ...
    MathBackendCPU.prototype.broadcastedBinaryOp = function (a, b, dtype, op) {
        ...
        if (aBroadcastDims.length + bBroadcastDims.length === 0) {
            ...
            var aBuf = a.bufferSync();
            var bBuf = b.bufferSync();
    ...
    MathBackendCPU.prototype.broadcastedBinaryComplexOp = function (a, b, op) {
        ...
        if (aBroadcastDims.length + bBroadcastDims.length === 0) {
            ...
            var aRealBuf = this.data.get(a.dataId).complexTensors.real.bufferSync();
            var bRealBuf = this.data.get(b.dataId).complexTensors.real.bufferSync();
